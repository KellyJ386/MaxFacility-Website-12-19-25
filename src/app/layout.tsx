...
export const metadata: Metadata = {
  ...
  description:
    "Expert ice rink consulting, maintenance services, and MFO software platform. 30+ years of experience elevating ice facility operations. CIT, CIRM, CRA certified.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Expert ice rink consulting, maintenance services, and MFO software platform. 30+ years of experience elevating ice facility operations.",
